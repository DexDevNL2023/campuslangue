...
public class DroitControllerImpl implements DroitController {
    ...
    public DroitDTO save(@Valid @RequestBody DroitRequestDTO dto) {
        autorisationService.addDroit(new SaveDroitDTO("Administration", "Ajouter un droit", "droit-add", "POST", false));
    ...
    public List<LiteDroitDTO> saveAll(@Valid @RequestBody List<ImportDroitRequestDTO> dtos) {
        autorisationService.addDroit(new SaveDroitDTO("Administration", "Importer des droits", "droit-import", "POST", false));
    ...
    public DroitDTO findById(@PathVariable("id") Long id) {
        autorisationService.addDroit(new SaveDroitDTO("Administration", "Détails d'un droit", "droit-details", "GET", false));
    ...
    public void delete(@PathVariable("id") Long id) {
        autorisationService.addDroit(new SaveDroitDTO("Administration", "Supprimer un droit", "droit-delet", "DELET", false));
    ...
    public List<LiteDroitDTO> list() {
        autorisationService.addDroit(new SaveDroitDTO("Administration", "Lister les droits", "droit-list", "GET", false));
    ...
    public void update(@Valid @RequestBody DroitRequestDTO dto, @PathVariable("id") Long id) {
        autorisationService.addDroit(new SaveDroitDTO("Administration", "Modifier un droit", "droit-edit", "PUT", false));
        if (service.findById(id) == null) throw new RuntimeException("Le droit avec l'id " + id + " n'existe pas");
